...
FILES_DIR = r"C:\Users\aghosh_511\Desktop\DGH_Files\LogicalDoc Py files\GIT\final\LogicalDoc_migration\PDF\Uploads"
    ...
    for refid, file_name, regime, block, created_on, file_id in rows:
        ...
        try:
            ...
            if logical_doc_id:
                ...
                update_sql = "UPDATE FRAMEWORK01.CMS_FILES SET LOGICAL_DOC_ID = :1, LABEL_ID = :2,REFID =:3 WHERE FILE_ID = :4"
                cursor.execute(update_sql, (logical_doc_id, label_id, refid, file_id))
            else:
